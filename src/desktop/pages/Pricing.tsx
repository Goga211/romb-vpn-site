...
const PLANS: Plan[] = [
  {
    ...
    features: ['3 устройства', '100 ГБ трафика', 'Без привязки карты'],
  ...
  },
  {
    ...
    price: '$19',
    period: '/ 6 мес',
    sub: '≈ 1450 ₽ · оплата переводом через МБАНК',
    subAccent: true,
...
const INCLUDED = ['Стабильное соединение', 'Поддержка 24/7', 'Отмена в любой момент']
